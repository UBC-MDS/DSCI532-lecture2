...
# Step 2. Select the results/metrics that you want for your target audience{background-color="#33cccc"}
...
* ""Percentage of hospitalizations" **-> Text box** (could be part of a plot)
...
# Recommendation
👀 Check [Shiny app galleries](https://github.ubc.ca/MDS-2022-23/DSCI_532_viz-2_students/issues/1).
...
![](img/parentesis.png){fig-align='center'}
